...
<body>
  ...
  <div class="domain-section">
    <div class="domain-container">
      <div class="grid-box">
        <div class="icon"
          style="background-image:url(<?php echo base_url(); ?>/assets/ourdomains/MLAI.jpg);background-attachment: cover;background-position: center;background-repeat: no-repeat;background-size: cover;">
      ...
      <div class="grid-box" style="background-color: rgb(255, 61, 61);">
        <div class="icon"
          style="background-image:url(<?php echo base_url(); ?>/assets/ourdomains/robo1.jpg);background-attachment: cover;background-position: center;background-repeat: no-repeat;background-size: cover;">
      ...
      <div class="grid-box" style="background-color: rgb(144, 218, 144);">
        <div class="icon"
          style="background-image:url(<?php echo base_url(); ?>/assets/ourdomains/blockchain.jpg);background-attachment: cover;background-position: center;background-repeat: no-repeat;background-size: cover;">
      ...
      <div class="grid-box" style="background-color:rgb(0,135,125);">
        <div class="icon"
          style="background-image:url(<?php echo base_url(); ?>/assets/ourdomains/bigdata.jpg);background-attachment: cover;background-position: center;background-repeat: no-repeat;background-size: cover;">
      ...
      <div class="grid-box" style="background-color: rgb(250, 131, 151);">
        <div class="icon"
          style="background-image:url(<?php echo base_url(); ?>/assets/ourdomains/IoT.png);background-attachment: cover;background-position: center;background-repeat: no-repeat;background-size: cover;">
      ...
      <div class="grid-box" style="background-color: goldenrod;">
        <div class="icon"
          style="background-image:url(<?php echo base_url(); ?>/assets/ourdomains/web.jpg);background-attachment: cover;background-position: center;background-repeat: no-repeat;background-size: cover;">
  ...
  <div id="ourpartners">
    ...
    <p class="para_text">Our clients are people and organizations with ambition and imagination to unleash the power of
      IT for their businesses and ideas.</p>
    ...
    <section class="card-section">
      <div class="card">
        <div class="flip-card">
          <div class="flip-card__container">
            <div class="card-front">
              <img src="<?php echo base_url(); ?>assets/client/new/prime/img12.png" alt="" style="margin-top: 50px;">
            </div>
            <div class="card-back">
              <img src="<?php echo base_url(); ?>assets/client/new/prime/img12.png" alt="" style="margin-top: 50px;">
            </div>
