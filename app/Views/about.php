...
<body>
  ...
  <div class="content">
    ...
    <div class="ui segment" style="font-size:16px; margin-top:5%;border:none;">
            <img class="ui centered massive image" src="<?php echo base_url(); ?>/assets/aboutimages/abt1.jpg"></div>
      ...
      <div style="padding-top:7% ;">
        <img class="ui big left floated image" src="<?php echo base_url(); ?>/assets/aboutimages/abt5.png"><br>
        <h1 >Our Vision</h1>
        <p>We genuinely believe the potential impact of the Internet of Things will revolutionize profitable commerce worldwide and improve sufficiently our modern lives with intelligent devices. Our principal aim is precisely to contribute
      ...
      <div style="padding:7% 2%;">
          <img class="ui big right floated image" src="<?php echo base_url(); ?>/assets/aboutimages/abt3.png"><br>
        <h1 style="margin-top:7%;" >Our Mission</h1>
        <p> To solve efficiently complex business and modern world challenges by efficiently providing digital solutions and help businesses unleash their own Internet of Things in the most cost-effective and innovative way.</p>
      </div>

      <div style="padding:9% 2%;">
        <img class="ui big left floated image" src="<?php echo base_url(); ?>/assets/aboutimages/abt4.jpg"><br>
        <h1 style="margin-top:0;">About Us</h1>
        <p> Quantanics was founded in 2018 by a group of young and rejuvenated engineers who wanted to prove their stand in Industry 4.0 by making this world a better place to live. Today, we established a distinguished reputation by
