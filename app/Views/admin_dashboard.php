                        ...
                        <div class="row profile_permission_card g-4">
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <div id="cards_landscape_wrap-2">
                                    <div class="card">
                                        <img src="https://images.freeimages.com/images/large-previews/7b4/grey-catbird-in-profile-1641861.jpg"
                                            class="card-img-top" alt="..." style="display:flex" >
                                        <div class="card-body">
                                            <div>
                                                ...
                                                <div class="read-more-wrap ">
                                                    ...
                                                    <div class="read-more-target">nithi ipsum dolor sit amet consectetur
                                                        adipisicing elit
                                                ...
                                                <div class="row" style="display:flex">
                                                    <div class="col d-flex justify-content-center gap-4">
                                                        <button type="button" class="btn btn-outline-success"> Accept
                                                        </button>
                                                        <button type="button"
