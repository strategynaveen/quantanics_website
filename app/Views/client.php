...
<head>
  ...
  <!-- stylesheet-->
  <link rel="stylesheet" href="<?php echo base_url(); ?>/assets/css/client1.css">
  <!-- google font -->
        ...
        <section class="card-section">
          <div class="card">
            <div class="flip-card">
              <div class="flip-card__container">
                <div class="card-front">
                  <img src="<?php echo base_url(); ?>/assets/client/new/prime/img27.png " alt="" style="margin-top: 40px;">
                </div>
                <div class="card-back">
                  <img src="<?php echo base_url(); ?>/assets/client/new/prime/img27.png " alt="" style="margin-top: 40px;">
                </div>
        ...
        <section class="card-section">
          <div class="card">
            <div class="flip-card">
              <div class="flip-card__container">
                <div class="card-front">
                  <img src="<?php echo base_url(); ?>/assets/client/new/prime/img14(1).png" alt="" style="margin-top: 50px;">
                </div>
                <div class="card-back">
                  <img src="<?php echo base_url(); ?>/assets/client/new/prime/img14(1).png" alt="" style="margin-top: 50px;">
                </div>
      ...
      <section class="card-section">
        <div class="card">
          <div class="flip-card">
            <div class="flip-card__container">
              <div class="card-front">
                <img src="<?php echo base_url(); ?>/assets/client/new/academic/img (12).png" alt=""style="margin-top: 0px;">
              </div>
              <div class="card-back">
                <img src="<?php echo base_url(); ?>/assets/client/new/academic/img (12).png" alt=""style="margin-top: 0px;">
              </div>
      ...
      <section class="card-section">
        <div class="card">
          <div class="flip-card">
            <div class="flip-card__container">
              <div class="card-front">
                <img src="<?php echo base_url(); ?>/assets/client/new/academic/img (29).png" alt=""style="margin-top: 35px;">
              </div>
              <div class="card-back">
                <img src="<?php echo base_url(); ?>/assets/client/new/academic/img (29).png" alt=""style="margin-top: 35px;">
              </div>
      ...
      <section class="card-section">
        <div class="card">
          <div class="flip-card">
            <div class="flip-card__container">
              <div class="card-front">
                <img src="<?php echo base_url(); ?>/assets/client/new/academic/img (11).png"alt=""style="margin-top: 20px;">
              </div>
              <div class="card-back">
                <img src="<?php echo base_url(); ?>/assets/client/new/academic/img (11).png"alt=""style="margin-top: 20px;">
              </div>
      ...
      <section class="card-section">
        <div class="card">
          <div class="flip-card">
            <div class="flip-card__container">
              <div class="card-front">
                <img src="<?php echo base_url(); ?>/assets/client/new/academic/img (7).png" alt=""style="margin-top: 15px;">
              </div>
              <div class="card-back">
                <img src="<?php echo base_url(); ?>/assets/client/new/academic/img (7).png" alt=""style="margin-top: 15px;">
              </div>
      ...
      <section class="card-section">
        <div class="card">
          <div class="flip-card">
            <div class="flip-card__container">
              <div class="card-front">
                <img src="<?php echo base_url(); ?>/assets/client/new/academic/img (1).jpg" alt="" style="margin-top: 20px;">
              </div>
              <div class="card-back">
                <img src="<?php echo base_url(); ?>/assets/client/new/academic/img (1).jpg" alt="" style="margin-top: 20px;">
              </div>
      ...
      <section class="card-section">
        <div class="card">
          <div class="flip-card">
            <div class="flip-card__container">
              <div class="card-front">
                <img src="<?php echo base_url(); ?>/assets/client/new/academic/img (22).png" alt=""style="margin-top: 0px;">
              </div>
              <div class="card-back">
                <img src="<?php echo base_url(); ?>/assets/client/new/academic/img (22).png" alt=""style="margin-top: 0px;">
              </div>
      ...
      <section class="card-section">
        <div class="card">
          <div class="flip-card">
            <div class="flip-card__container">
              <div class="card-front">
                <img src="<?php echo base_url(); ?>/assets/client/new/academic/img (28).png" alt=""style="margin-top: 5px;">
              </div>
              <div class="card-back">
                <img src="<?php echo base_url(); ?>/assets/client/new/academic/img (28).png" alt=""style="margin-top: 5px;">
              </div>
      ...
      <section class="card-section">
        <div class="card">
          <div class="flip-card">
            <div class="flip-card__container">
              <div class="card-front">
                <img src="<?php echo base_url(); ?>/assets/client/new/academic/tiruvalluvar.jpg" alt=""style="margin-top: 0px;">
              </div>
              <div class="card-back">
                <img src="<?php echo base_url(); ?>/assets/client/new/academic/tiruvalluvar.jpg" alt=""style="margin-top: 0px;">
              </div>
      ...
      <section class="card-section">
        <div class="card">
          <div class="flip-card">
            <div class="flip-card__container">
              <div class="card-front">
                <img src="<?php echo base_url(); ?>/assets/client/new/academic/img (3).jpg"alt=""style="margin-top: 15px;">
              </div>
              <div class="card-back">
                <img src="<?php echo base_url(); ?>/assets/client/new/academic/img (3).jpg"alt=""style="margin-top: 15px;">
              </div>
      ...
      <section class="card-section">
        <div class="card">
          <div class="flip-card">
            <div class="flip-card__container">
              <div class="card-front">
                <img src="<?php echo base_url(); ?>/assets/client/new/academic/img (14).png" alt="" style="margin-top: 50px;">
              </div>
              <div class="card-back">
                <img src="<?php echo base_url(); ?>/assets/client/new/academic/img (14).png" alt="" style="margin-top: 50px;">
              </div>
