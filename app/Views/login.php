        ...
        $(document).on('click','#intern_log_btn',function(event){
            ...
            $.ajax({
                    ...
                    success:function(res){
                        ...
                        if (res === "success") {
                            // alert("login success");
                            location.replace("<?php echo base_url(); ?>public/index.php/Home/load_option/intern_after");
                        }
                        else if(res==="waiting"){
                            alert("Your Request Is Waiting list after confirm send the Check the Mail");
                        }
                        else if(res==="new"){
                            alert("New User");
